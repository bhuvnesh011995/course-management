    ...
    var i = {
        ...
        e = function() {
            ...
            return _createClass(n, [{
                ...
                key: "_load",
                value: function() {
                    this.pages.hide(), this.steps.removeClass([this.options.style.anchorDoneCss, this.options.style.anchorActiveCss]);
                ...
                value: function() {
                    ...
                    }).addClass(this.options.style.mainCss + " " + this.options.style.themePrefixCss + this.options.theme), this.main.toggleClass(this.options.style.justifiedCss, this.options.justified), !0 === this.options.anchor.enableNavigationAlways && !0 === this.options.anchor.enableNavigation || this.steps.addClass(this.options.style.anchorDefaultCss), l.each(this.options.disabledSteps, function(t, s) {
                ...
                value: function() {
                    ...
                    this.steps.on("click", function(t) {
                        ...
                        var s;
                        !0 !== e.options.backButtonSupport || !1 !== (s = e._getURLHashIndex()) && e._isShowable(e.steps.eq(s)) && (t.preventDefault(), e._showStep(s))
                ...
                key: "_createToolbar",
                value: function(t) {
                    var s = l("<div></div>").addClass("sw-toolbar-elm justify-content-between " + this.options.style.toolbarCss + " " + this.options.style.toolbarPrefixCss + t).attr("role", "toolbar"),
                ...
                value: function(n) {
                    ...
                    this._loadContent(n, function() {
                        ...
                        i._transit(e, s, o, function() {
                            i._fixHeight(n), i._triggerEvent("showStep", [t, n, o, i._getStepPosition(n)])
                        }), i.current_index = n, i._setButtons(n), i._setProgressbar(n)
                    })
                }
            }, {
                key: "_getShowable",
                ...
                value: function(s, e, t, n) {
                    ...
                    this._stopAnimations(), l.isFunction(i) ? i(s, e, t, this, function(t) {
                ...
                key: "_stopAnimations",
                value: function() {
                    l.isFunction(this.container.finish) && (this.pages.finish(), this.container.finish())
                }
            }, {
                key: "_fixHeight",
                value: function(t) {
                ...
                value: function(t) {
                    var s, e;
                    null !== this.current_index && 0 <= this.current_index && (s = this.options.style.anchorActiveCss, e = "", !1 !== this.options.anchor.enableDoneState && (e += this.options.style.anchorDoneCss, !1 !== this.options.anchor.unDoneOnBackNavigation && "backward" === this._getStepDirection(t) && (s += " " + this.options.style.anchorDoneCss)), this.steps.eq(this.current_index).addClass(e).removeClass(s)), this.steps.eq(t).removeClass(this.options.style.anchorDoneCss).addClass(this.options.style.anchorActiveCss)
                }
            }, {
                key: "_setButtons",
                value: function(t) {
                ...
                key: "reset",
                value: function() {
                    this.steps.removeClass([this.options.style.anchorDoneCss, this.options.style.anchorActiveCss, this.options.style.anchorErrorCss, this.options.style.anchorWarningCss]), this._setURLHash("#"), this._init(), this._load()
                }
            }, {
                key: "setState",
                value: function(t, s) {
