    ...
    if (webhookData?.Form?.FormID == "5155773") {
      ...
      if (registrationType) {
        ...
        if (webhookFormData["85079583"]["Value"]) {
          ...
          leadObj.fileLocations.pa =
            webhookFormData["85079583"]["Value"][0]["url"];
        }
        if (webhookFormData["85079584"]["Value"]) {
          leadObj["workersIc"] =
            webhookFormData["85079584"]["Value"][0]["filename"];
          leadObj.fileLocations.ISC =
            webhookFormData["85079584"]["Value"][0]["url"];
        }
